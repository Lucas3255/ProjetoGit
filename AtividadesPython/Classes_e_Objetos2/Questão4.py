# 4 Crie uma classe para representar um horario (hora, minuto e segundo). Implemente os metodos para
# fazer as operacoes de incremento (de segundos) no horario e diferença entre dois horarios.
